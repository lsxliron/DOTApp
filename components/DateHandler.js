        ...
        <div className="row">
          ...
          <div className="col-xs-2">
            <div className="input-group date">
              <DateTimeField ref="startDate" onChange={this.setValidDateRange}  inputFormat="MM-DD-YYYY" mode="date" minDate={moment('01-01-1900', 'MM-DD-YYYY')} maxDate={this.state.endDate} dateTime={this.state.startDate.format('x')} widgetClasses={{top:true,bottom:false}}/>
            </div>
          </div>
        </div>
        <div className="row">  
